...
export class MateriaService {
   ...
   */
  actualizarRecurso(materiaId: number, recursoId: number, dto: CreateRecursoDto): Observable<any> {
    return this.http.put(`${this.apiUrl}/Materia/${materiaId}/recursos/${recursoId}`, dto);
  }
  ...
  actualizarActividad(
    ...
    return this.http.put(`${this.apiUrl}/Materia/${materiaId}/actividades/${actividadId}`, dto);
  }
  ...
  agregarEstudiantesAMateria(
    ...
    return this.http
      .post(`${this.apiUrl}/Materia/${materiaId}/estudiantes`, {
        estudianteIds,
      })
      .pipe(
        catchError(() =>
